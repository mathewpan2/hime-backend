...
class ServeClientBase(object):
    ...
    def add_frames(self, frame_np):
        ...
        # ensures the buffer holds x seconds of voice data


        # if holds more than 10 seconds of data, discard the first 5 seconds
        self.lock.acquire()
        # n = 5
        # if self.frames_np is not None and self.frames_np.shape[0] > 10*self.RATE:
        #     self.frames_offset += n
        #     self.frames_np = self.frames_np[int(n*self.RATE):]
...
class ServeClientFasterWhisper(ServeClientBase):
    ...
    def speech_to_text(self):
        ...
        while True:
            ...
            samples_take = self.sample_offset
            ...
            try:
                ...
                if len(result):
                    ...
                    self.sample_offset = self.frames_np.shape[0]
                    segments = result[0][4]
                else: # no output from whisper aka a pause
                    segments = ''    
                # else:
